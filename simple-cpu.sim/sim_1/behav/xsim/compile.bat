...
REM
REM Generated by Vivado on Fri Aug 08 21:32:50 -0600 2025
...
echo "xvhdl --incr --relax -prj tb_cpu_mission_1_vhdl.prj"
call xvhdl  --incr --relax -prj tb_cpu_mission_1_vhdl.prj -log xvhdl.log
