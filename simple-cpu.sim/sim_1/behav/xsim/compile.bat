...
REM
REM Generated by Vivado on Sun Dec 28 16:28:22 -0600 2025
...
echo "xvhdl --incr --relax -prj tb_cpu_system_vhdl.prj"
call xvhdl  --incr --relax -prj tb_cpu_system_vhdl.prj -log xvhdl.log
